...
describe BbGun::Converter do

  describe ".to_markdown" do
    it "initializes #{described_class} with parameter as an input and converts it" do
      described_class.to_markdown("text").should == "text"
    end
  end
  ...
  describe "#to_markdown" do
    ...
    it "converts image tag" do
      described_class.new("[img]http://i2.kym-cdn.com/entries/icons/original/000/000/007/rickroll.jpg[/img]").to_markdown.should == \
        "![](http://i2.kym-cdn.com/entries/icons/original/000/000/007/rickroll.jpg)"
    end

    it "converts embed tags" do
      described_class.new("[b]Bold [i]Italic[/i][/b]").to_markdown.should == "**Bold *Italic***"
    end
